...
function zerif_big_title_text_function() {
	...
	$zerif_bigtitle_title = get_theme_mod('zerif_bigtitle_title',__('For All Your Cable Needs/Setup','zerif-lite'));
...
function zerif_about_us_header_subtitle_function() {
	$zerif_aboutus_subtitle = get_theme_mod('zerif_aboutus_subtitle',__('Use this section to showcase1 important details about your business.','zerif-lite'));
